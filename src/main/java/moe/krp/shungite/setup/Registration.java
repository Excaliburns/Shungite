...
public class Registration {
    ...
    public static final DeferredRegister<MobEffect> EFFECT_DEFERRED_REGISTER = DeferredRegister.create(ForgeRegistries.MOB_EFFECTS, ShungiteConstants.MOD_ID);
    public static final DeferredRegister<ShungiteEffect> SHUNGITE_EFFECT_DEFERRED_REGISTER = DeferredRegister.create(new ResourceLocation(ShungiteConstants.MOD_ID, ShungiteConstants.SHUNGITE_EFFECT_REGISTRY_KEY), ShungiteConstants.MOD_ID);
    public static final DeferredRegister<LootItemFunctionType> LOOT_ITEM_FUNCTION_TYPE_DEFERRED_REGISTER = DeferredRegister.create(Registry.LOOT_FUNCTION_REGISTRY, ShungiteConstants.MOD_ID);
